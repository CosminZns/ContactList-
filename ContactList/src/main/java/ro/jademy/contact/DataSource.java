...
public  class DataSource {
    ...
    public static List<Contact> returnContacs(){
        Contact contact = new Contact("Andreescu", "Andrei", "0723123456", Group.FAMILY, "andrei@gmail.com");
        Contact contact1 = new Contact("Alexandrescu", "Mihai", "0723135456", Group.FRIENDS, "mihai@gmail.com");
        Contact contact2 = new Contact("Marinescu", "Vlad", "0723123890", Group.FAMILY, "vlad@gmail.com");
        Contact contact3 = new Contact("Basescu", "Traian", "0723123456", Group.FAMILY, "traian@gmail.com");
