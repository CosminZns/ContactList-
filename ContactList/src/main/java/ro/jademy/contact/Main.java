...
public class Main {
    public static void main(String[] args) {
        ...
        Contact contact4 = new Contact("Popa", "Carmen", "0728193156", "Work", "traian@gmail.com");
        Contact contact5 = new Contact("Lazar", "Andreea", "0723823459", "Friends", "traian@gmail.com");

        //     Contact contact6 = new Contact("Vasile", "Andrei", "0753113469");
        Contact contact7 = new Contact("Vasile", "Andrei", "0753113460", "Family", "traian@gmail.com");
